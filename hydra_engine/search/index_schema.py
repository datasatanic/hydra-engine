...
class HydraIndexScheme(SchemaClass):
    ...
    def __new__(cls):
        ...
        obj.showable_fields = ['output_url', 'input_url', 'entity', 'display_name', 'description']
        obj.searchable_fields = ['entity', 'display_name', 'description']
        obj.highlightable = ['display_name', 'description']
        return obj
